    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--tz-text-secondary)', marginTop: 3 }} className="responsive-header-greeting-sub">
          {user?.employeeId ? `Employee ID: ${user.employeeId}` : "Here's what's happening with your work today."}
        </p>
      </div>

      {/* Live Employee Activity & Shift Tracker */}
      <LiveTrackerWidget />
      ...
      <NotificationBell fullPagePath="/employee/notifications" />
        ...
        {dropdownOpen && (
          ...
          >
            <div style={{ padding: '8px 12px', borderBottom: '1px solid var(--tz-border)' }}>
              ...
              {user?.employeeId && (
                <p style={{ fontSize: 11, color: 'var(--tz-red-primary)', fontWeight: 600, margin: '2px 0 0 0' }}>
                  {user.employeeId}
                </p>
              )}
            </div>
